...
import CurvedLink from './CurvedLink.component';
...
initialState = Flow.addNode(
	initialState,
	Node.create('id3', Position.create(800, 40), Size.create(160, 80), 'basicnode'),
);
...
initialState = Flow.addLink(initialState, Link.create('id2', 'id3', 'id4', 'curvedlink'));
		...
		<Provider store={store}>
			<div style={{ height: '800px' }}>
				<FlowDesigner reduxMountPoint="pipeline" style={{ height: '100%' }}>
					...
					<LinkType type="curvedlink" component={CurvedLink} />
