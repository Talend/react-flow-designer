...
describe('FLOWDESIGNER_FLOW_ADD_ELEMENTS', () => {
  it('should batch one element creation', () => {
    expect(reducer(defaultState, {
      ...
      listOfActionCreation: [nodeActions.addNode('nodeId', undefined, {
        data: {},
        graphicalAttributes: {
...
describe('calculatePortsPosition behavior', () => {
  const state = defaultState.set('nodes', new Map().set('42', new NodeRecord({
    id: '42',
    graphicalAttributes: new Map({
      nodeType: '42'
    })
  }))).set('ports', new Map().set('42', new PortRecord({
    id: '42',
    nodeId: '42'
