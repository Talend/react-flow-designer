...
describe('Testing <AbstractNode>', () => {
  it('should create a bare node component with provided position', () => {
    const wrapper = mount(<AbstractNode node={node} startMoveNodeTo={noOp} moveNodeTo={noOp} moveNodeToEnd={noOp}>
	<rect />
                          </AbstractNode>);
  ...
  it('call the injected onClick action when clicked', () => {
    ...
    const wrapper = mount(<AbstractNode node={node} onClick={onClick} startMoveNodeTo={noOp} moveNodeTo={noOp} moveNodeToEnd={noOp}>
	<rect />
                          </AbstractNode>);
  ...
  xit('call the injected onDragStart action when drag action start', done => {
    ...
    mount(<AbstractNode node={node} onClick={onDragStart} startMoveNodeTo={noOp} moveNodeTo={noOp} moveNodeToEnd={noOp}>
	<rect />
          </AbstractNode>, { attachTo: document.body });
