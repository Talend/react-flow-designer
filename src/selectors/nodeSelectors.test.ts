...
describe('Testing node selectors', () => {
  ...
  const givenState = new Map({
    nodes: new Map().set('id1', node1).set('id2', node2).set('id3', node3).set('id4', node4).set('id5', node5).set('id6', node6).set('id7', node7).set('id8', node8),
    ports: new OrderedMap().set('id1', port1).set('id2', port2).set('id3', port3).set('id4', port4).set('id5', port5).set('id6', port6).set('id7', port7).set('id8', port8).set('id9', port9).set('id10', port10).set('id11', port11).set('id12', port12).set('id13', port13).set('id14', port14).set('id15', port15).set('id16', port16),
    links: new Map().set('id1', link1).set('id2', link2).set('id3', link3).set('id4', link4).set('id5', link5).set('id6', link6).set('id7', link7).set('id8', link8),
    parents: new Map().set('id1', new Map({})).set('id2', new Map({ id1: 'id1' })).set('id3', new Map({ id2: 'id2' })).set('id4', new Map({ id2: 'id2' })).set('id5', new Map({ id3: 'id3' })).set('id6', new Map({ id4: 'id4' })).set('id7', new Map({ id5: 'id5', id6: 'id6' })).set('id8', new Map({ id7: 'id7' })),
    childrens: new Map().set('id1', new Map({ id2: 'id2' })).set('id2', new Map({ id3: 'id3', id4: 'id4' })).set('id3', new Map({ id5: 'id5' })).set('id4', new Map({ id6: 'id6' })).set('id5', new Map({ id7: 'id7' })).set('id6', new Map({ id7: 'id7' })).set('id7', new Map({ id8: 'id8' })).set('id8', new Map({}))
  });
