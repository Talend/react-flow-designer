...
const protectedValueException = 'position is a protected value of the Node, please use getPosition setPosition from this module to make change on those values';
...
describe('Node', () => {
  ...
  describe('create', () => {
    ...
    it('throw if given an improper id', () => {
      ...
      // when
      // expect
      expect(() => Node.create(improperId, position, size, nodeType)).toThrow('nodeId should be a string, was given 34');
    });
    ...
    it('throw if given an improper componentType', () => {
      ...
      // when
      // expect
      expect(() => Node.create(id, position, size, improperNodeType)).toThrow('nodeType should be a string, was given [object Object]');
    });
  });
  ...
  describe('setPosition', () => {
    ...
    it('throw given an improper Position', () => {
      ...
      // when
      // expect
      expect(() => Node.setPosition(improperPosition, testNode)).toThrow(`PositionRecord should be a PositionRecord, was given
"""
object
"""
Map { "x": 10, "y": 10 }
...
you should use Position module functions to create and transform Position`);
  ...
  describe('setComponentType', () => {
    ...
    it('throw given an improper ComponentType', () => {
      ...
      // when
      // expect
      expect(() => Node.setComponentType(newComponentType, testNode)).toThrow('nodeType should be a string, was given [object Object]');
    });
    it('throw given an improper Node', () => {
      // given
      // when
  ...
  describe('setGraphicalAttribute', () => {
    ...
    it('throw given a key being part of FORBIDEN_GRAPHICAL_ATTRIBUTES', () => {
      ...
      // when
      // expect
      expect(() => Node.setGraphicalAttribute(improperNewKey, newValue, testNode)).toThrow(protectedValueException);
    });
    it('throw given an improper key', () => {
      // given
      const improperKey = 8;
      // when
      // expect
      expect(() => Node.setGraphicalAttribute(improperKey, value, testNode)).toThrow(Data.isNotKeyException);
    });
    it('throw given an improper node', () => {
      // given
      // when
      // expect
      expect(() => Node.setGraphicalAttribute(key, value, improperNode)).toThrow(isNotNodeException);
    });
  });
  describe('getGraphicalAttribute', () => {
    ...
    it('throw given a key being part of FORBIDEN_GRAPHICAL_ATTRIBUTES', () => {
      ...
      // when
      // expect
      expect(() => Node.getGraphicalAttribute(improperNewKey, testNode)).toThrow(protectedValueException);
    });
    it('throw given an improper key', () => {
      // given
      const improperKey = 8;
      // when
      // expect
      expect(() => Node.getGraphicalAttribute(improperKey, testNode)).toThrow(Data.isNotKeyException);
    });
    it('throw given an improper node', () => {
      // given
      // when
  ...
  describe('hasGraphicalAttribute', () => {
    ...
    it('throw given a key being part of FORBIDEN_GRAPHICAL_ATTRIBUTES', () => {
      ...
      // when
      // expect
      expect(() => Node.hasGraphicalAttribute(improperKey, testNode)).toThrow(protectedValueException);
    });
    it('throw given an improper key', () => {
      // given
      const improperKey = 8;
      // when
      // expect
      expect(() => Node.hasGraphicalAttribute(improperKey, testNode)).toThrow(Data.isNotKeyException);
    });
    it('throw given an improper node', () => {
      // given
      // when
  ...
  describe('deleteGraphicalAttribute', () => {
    ...
    it('throw given a key being part of FORBIDEN_GRAPHICAL_ATTRIBUTES', () => {
      ...
      // when
      // expect
      expect(() => Node.deleteGraphicalAttribute(improperKey, testNode)).toThrow(protectedValueException);
    });
    it('throw given an improper key', () => {
      // given
      const improperKey = 8;
      // when
      // expect
      expect(() => Node.deleteGraphicalAttribute(improperKey, testNode)).toThrow(Data.isNotKeyException);
    });
    it('throw given an improper node', () => {
      // given
      // when
