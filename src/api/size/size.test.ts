...
describe('Size', () => {
  ...
  describe('setWidth', () => {
    ...
    it('throw given an improper width', () => {
      ...
      // when
      // expect
      expect(() => Size.setWidth(improperWidth, testSize)).toThrow('width should be a number, was given 10  of type string');
    });
  ...
  describe('setHeight', () => {
    ...
    it('throw given an improper height', () => {
      ...
      // when
      // expect
      expect(() => Size.setHeight(improperHeight, testSize)).toThrow('height should be a number, was given 50  of type string');
    });
    it('throw given an improper Size', () => {
      // given
      // when
