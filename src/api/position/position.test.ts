...
describe('Position', () => {
  ...
  describe('getXCoordinate', () => {
    ...
    it('throw given an improper position', () => {
      expect(() => Position.getXCoordinate(improperTestPosition)).toThrow(improperPositionException);
    });
  });
  describe('setXCoordinate', () => {
    ...
    it('throw given an improper X coordinate', () => {
      ...
      // when
      // expect
      expect(() => Position.setXCoordinate(improperX, testPosition)).toThrow('x should be a number, was given 10 of type string');
    });
    it('throw given an improper Position', () => {
      // given
      // when
      // expect
      expect(() => Position.setXCoordinate(x, improperTestPosition)).toThrow(improperPositionException);
    });
  });
  describe('getYCoordinate', () => {
    ...
    it('throw given an improper position', () => {
      expect(() => Position.getYCoordinate(improperTestPosition)).toThrow(improperPositionException);
    });
  });
  describe('setYCoordinate', () => {
    ...
    it('throw given an improperY coordinate', () => {
      ...
      // when
      // expect
      expect(() => Position.setYCoordinate(improperY, testPosition)).toThrow('y should be a number, was given 50 of type string');
    });
    it('throw given an improper Position', () => {
      // given
      // when
      // expect
      expect(() => Position.setYCoordinate(y, improperTestPosition)).toThrow(improperPositionException);
    });
  });
});