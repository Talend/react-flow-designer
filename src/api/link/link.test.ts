...
const protectedValueException = 'linkType is a protected value of the Link, please use getLinkType setLinkType from this module to make change on those values';
...
describe('Link', () => {
  ...
  describe('create', () => {
    ...
    it('throw if given an improper id', () => {
      ...
      // when
      // expect
      expect(() => Link.create(improperId, sourceId, targetId, linkType)).toThrow('id should be a string, was given 34');
    });
    it('throw if given an improper sourceId', () => {
      // given
      // when
      // expect
      expect(() => Link.create(id, improperSourceId, targetId, linkType)).toThrow('id should be a string, was given 42');
    });
    it('throw if given an improper targetId', () => {
      // given
      // when
      // expect
      expect(() => Link.create(id, sourceId, improperTargetId, linkType)).toThrow('id should be a string, was given 64');
    });
    it('throw if given an improper componentType', () => {
      // given
      // when
      // expect
      expect(() => Link.create(id, sourceId, targetId, improperLinkType)).toThrow('linkType should be a string, was given [object Object]');
    });
  });
  describe('isLink', () => {
    it('return true if parameter link is a LinkRecord', () => {
  ...
  describe('setSourceId', () => {
    ...
    it('throw given an improper SourceId', () => {
      ...
      // when
      // expect
      expect(() => Link.setSourceId(improperSourceId, testLink)).toThrow('id should be a string, was given 42');
    });
    it('throw given an improper Link', () => {
      // given
      // when
  ...
  describe('setTargetId', () => {
    ...
    it('throw given an improper TargetId', () => {
      ...
      // when
      // expect
      expect(() => Link.setTargetId(improperTargetId, testLink)).toThrow('id should be a string, was given 64');
    });
    it('throw given an improper Link', () => {
      // given
      // when
  ...
  describe('setComponentType', () => {
    ...
    it('throw given an improper ComponentType', () => {
      ...
      // when
      // expect
      expect(() => Link.setComponentType(newComponentType, testLink)).toThrow('linkType should be a string, was given [object Object]');
    });
    it('throw given an improper Link', () => {
      // given
      // when
  ...
  describe('setGraphicalAttribute', () => {
    ...
    it('throw given a key being part of FORBIDEN_GRAPHICAL_ATTRIBUTES', () => {
      ...
      // when
      // expect
      expect(() => Link.setGraphicalAttribute(improperNewKey, newValue, testLink)).toThrow(protectedValueException);
    });
    it('throw given an improper key', () => {
      // given
      const improperKey = 8;
      // when
      // expect
      expect(() => Link.setGraphicalAttribute(improperKey, value, testLink)).toThrow(Data.isNotKeyException);
    });
    it('throw given an improper link', () => {
      // given
      // when
      // expect
      expect(() => Link.setGraphicalAttribute(key, value, improperLink)).toThrow(isNotLinkException);
    });
  });
  describe('getGraphicalAttribute', () => {
    ...
    it('throw given a key being part of FORBIDEN_GRAPHICAL_ATTRIBUTES', () => {
      ...
      // when
      // expect
      expect(() => Link.getGraphicalAttribute(improperNewKey, testLink)).toThrow(protectedValueException);
    });
    it('throw given an improper key', () => {
      // given
      const improperKey = 8;
      // when
      // expect
      expect(() => Link.getGraphicalAttribute(improperKey, testLink)).toThrow(Data.isNotKeyException);
    });
    it('throw given an improper link', () => {
      // given
      // when
  ...
  describe('hasGraphicalAttribute', () => {
    ...
    it('throw given a key being part of FORBIDEN_GRAPHICAL_ATTRIBUTES', () => {
      ...
      // when
      // expect
      expect(() => Link.hasGraphicalAttribute(improperKey, testLink)).toThrow(protectedValueException);
    });
    it('throw given an improper key', () => {
      // given
      const improperKey = 8;
      // when
      // expect
      expect(() => Link.hasGraphicalAttribute(improperKey, testLink)).toThrow(Data.isNotKeyException);
    });
    it('throw given an improper link', () => {
      // given
      // when
  ...
  describe('deleteGraphicalAttribute', () => {
    ...
    it('throw given a key being part of FORBIDEN_GRAPHICAL_ATTRIBUTES', () => {
      ...
      // when
      // expect
      expect(() => Link.deleteGraphicalAttribute(improperKey, testLink)).toThrow(protectedValueException);
    });
    it('throw given an improper key', () => {
      // given
      const improperKey = 8;
      // when
      // expect
      expect(() => Link.deleteGraphicalAttribute(improperKey, testLink)).toThrow(Data.isNotKeyException);
    });
    it('throw given an improper link', () => {
      // given
      // when
